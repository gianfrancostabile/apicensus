...
public class Endpoint {
    ...
    public static String BEAN_VALIDATOR_DEFAULT_GROUP, DIRECT_MISMATCHED_INPUT_FILE, DIRECT_BAD_REQUEST,
        ...
        DIRECT_FINDONEBYQUERY_SUCCESS, DIRECT_INSERT_DB_PERSON, DIRECT_INTERNAL_SERVER_ERROR,
        DIRECT_SET_EMPTY_RESPONSELIST, FILE_PERSON_FTP, MONGODB_PERSON_FINDONEBY_SSNANDCOUNTRY, MONGODB_PERSON_INSERT,
        REDIRECT_SWAGGER;
